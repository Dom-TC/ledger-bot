...
class TransactionCancelledError(ServiceError):
...
class TransactionApprovedError(ServiceError):
...
class TransactionInvalidBuyerError(ServiceError):
...
class TransactionInvalidSellerError(ServiceError):
...
class TransactionInvalidMemberError(ServiceError):
