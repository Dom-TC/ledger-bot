...
from ledger_bot.models import EventBotMessage
...
def test_bot_message_creation():
    ...
    bot_message = EventBotMessage.from_airtable(data)
    ...
    assert bot_message.event_id == "event456"
...
def test_bot_message_creation_invalid_types():
    ...
    with pytest.raises(TypeError) as excinfo:
        EventBotMessage.from_airtable(data)
